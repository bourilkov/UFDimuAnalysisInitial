...
int main(int argc, char* argv[])
{
    ...
    for(auto &c : categorySelection.categoryMap)
    {
        ...
        if(fewzHisto != 0 && dyHisto != 0)
        {
            ...
            //                                              list of histos    ,name  , title, xtitle,  ytitle,      , fit , ratiotitle,  log,  stats, legend
            TCanvas* stack = dps->stackedHistogramsAndRatio(c.second.histoList, cname, cname, varname, "Num Entries", true, "FEWZ/DY_MC", log, false, 1);
