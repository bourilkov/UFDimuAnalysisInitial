...
std::vector<Sample*>& GetSamples(std::map<TString, Sample*>& samples, TString location, TString select="ALL") {
  ...
  eras.push_back( std::make_tuple("G", 8407, std::vector<int>{107},     std::vector<TString>{"G/170128_235417"}) );
  eras.push_back( std::make_tuple("H", 8407, std::vector<int>{116,  4}, std::vector<TString>{"H_1/170128_235433", "H_2/170128_235449"}) );
